                ...
                <div>
                    ...
                    <select
                        ...
                        class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm
                               bg-white focus:outline-none focus:ring-2 focus:ring-indigo-100"
                    >
                        <option value="">
                            Tất cả trạng thái
                        </option>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @forelse($orders as $order)
                        ...
                        @php
                            ...
                            $methodClass =
                                $paymentMethodClasses[$order->payment_method]
                                ?? 'bg-gray-100 text-gray-700';
                        @endphp
                        ...
                        <tr class="hover:bg-gray-50/70 transition">
                            ...
                            <td class="px-5 py-4 text-center">
                                ...
                                <span class="inline-flex min-w-8 h-8 px-2
                            ...
                            <td class="px-5 py-4">
                                ...
                                <span class="inline-flex px-2.5 py-1 rounded-full
                                             text-xs font-semibold {{ $methodClass }}">
                                    {{ $methodText }}
                                </span>
                            ...
                            <td class="px-5 py-4 text-right">
                                ...
                                <a
                                    ...
                                    class="inline-flex items-center justify-center
                                           px-3 py-2 rounded-lg bg-indigo-50

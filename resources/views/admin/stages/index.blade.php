...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-5">
        ...
        <div>
            ...
            <p class="text-sm text-ink-soft mt-1">
                Quản lý các mốc phát triển của mẹ và bé trong hệ thống.
            </p>
        </div>
    ...
    <div class="card mb-5">
        ...
        >
            ...
            <button
                type="submit"
                class="px-5 py-2.5 rounded-xl bg-coral
                        ...
                        <tr class="hover:bg-admin-bg/60 transition">
                            ...
                            <td class="px-5 py-4">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div
                                        class="w-10 h-10 rounded-xl bg-coral-light
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-xs text-ink-soft">
                            Giai đoạn sẽ được ẩn khỏi danh sách
                            nhưng vẫn có thể khôi phục sau này.
                        </p>
